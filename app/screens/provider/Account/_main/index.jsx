...
const AccountScreen = () => {
    ...
    const getProfileData = async () => {
        try {
            const { result } = await authorizeProviderGet("authenticate/profileData", setError, setLoading)
        ...
        <View style={styles.mainContainer}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.head}>
                    <Header title="My Profile" showNotificationsIcon={false} />
                    {/* <Devider /> */}
                ...
                <View style={styles.body}>
                    ...
                    <SettingCards
                        ...
                        onClickHandler={() => {
                            navigateScreen(navigate, "PrivacyAndPolicy")
                        }}
                    />
                    {
                        // isLoggedIn &&
            ...
            {modalVisible && <LogOutModal hideModal={setModalVisible} onLogOut={onLogOut} />}
